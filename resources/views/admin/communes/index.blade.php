                ...
                <header class="px-5 py-4 border-b border-gray-100">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-3">
                        ...
                        <div class="col-span-12 md:col-span-8">
                            <h2 class="font-semibold text-gray-800">Comunas Agregadas</h2> 
                        </div>
                        <div class="col-span-12 md:col-span-4">

                            <p class=" text-center">
                            <a href="{{ route('communes.create') }}" class="px-3 py-2 font-semibold uppercase text-sm text-white bg-green-600 hover:bg-green-500 tracking-wider rounded-md transition">Nueva</a> 
                            </p>
                        </div>
                    </div>                
                </header>
                                ...
                                <tr>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="font-medium text-gray-800">{{ $commune->name }}</div>
                                        </div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-left">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            ...
                                            <form action="{{ route('communes.delete', $commune) }}" method="POST">
                                                @csrf
                                                @method('delete')
